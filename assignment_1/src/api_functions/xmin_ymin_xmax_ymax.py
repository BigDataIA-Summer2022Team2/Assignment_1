...
# if(xmin > xmax):
#     return {"error":"xmin is greater than xmax"}
# if(ymin > ymax):
#     return {"error":"ymin is greater than ymax"}
# if(xmax > width):
#     return {"error":"xmax is greater than width"}
# if(yamx > height):
#     return {"error":"yamx is greater than height"}
